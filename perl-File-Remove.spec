...
%prep
%setup -q -n File-Remove-1.61
cd %{_builddir}
tar xf %{_sourcedir}/libfile-remove-perl_1.57-1.debian.tar.xz
cd %{_builddir}/File-Remove-1.61
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/File-Remove-1.61/deblicense/
...
cp %{_builddir}/File-Remove-1.61/LICENSE %{buildroot}/usr/share/package-licenses/perl-File-Remove/c01411e4535ce0aea0deda74411ac0f2f5158bcd
